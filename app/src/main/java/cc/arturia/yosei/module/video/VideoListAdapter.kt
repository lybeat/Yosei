 ...
 * Date: 2018/10/16
 */
class VideoListAdapter(private val context: Context, data: List<Video>?)
    : BaseSelectAdapter<Video, BaseViewHolder>(R.layout.item_video, data) {
    ...
    override fun convert(k: BaseViewHolder, t: Video) {
        ...
        k.setText(R.id.tv_size, FileUtil.getFileSize(t.size!!))
