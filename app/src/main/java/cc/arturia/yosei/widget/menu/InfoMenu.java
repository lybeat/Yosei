 ...
 * Date: 2017/1/7
 */
public class InfoMenu extends FrameLayout implements IMenu {
    ...
    public InfoMenu(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public InfoMenu(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        inflate(getContext(), R.layout.menu_info, this);
        rootLayout = findViewById(R.id.root_layout);
        stateTxt = findViewById(R.id.tv_state);
